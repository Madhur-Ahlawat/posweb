...
function getOrderPriceByType($type)
{
...
function getDiscountPriceByType($type)
{
 ...
 $result = mysqli_query($con, "SELECT SUM(discount) AS value_sum FROM order_list");
  }
...
function getTaxPriceByType($type)
{
 ...
 $result = mysqli_query($con, "SELECT SUM(tax) AS value_sum FROM order_list");
  }
